...
<body>
    ...
    <div class="registro">
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" name="login" class="formulario">
            ...
            <div class="form-group">
                <i class="contra fa fa-unlock-alt"></i> <input type="password" name="password2" class="password-btn" placeholder="Repetir Contraseña">
                
            </div>
            <button onclick="login.submit()">
                <i class="submit-btn fa fa-check" ></i> Crear Cuenta
            </button>
        ...
        <div class="texto-login">
            ...
            <a href="login.php" class="iniciar_sesion">Iniciar Sesion</a>
        </div>
    </div>
</body>
</html>